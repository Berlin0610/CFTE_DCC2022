...
if __name__ == "__main__":
    ...
    for lamda in ['L1']:
        ...
        result_dir = '../experiment/evaluation/'+str(lamda)+'/'
        ...
        metric = {'psnr': 1, 'ssim': 1, 'lpips': 0, 'dists': 0}
        ...
        for seq in seqlist:
            ...
            for qp in qplist:
                ...
                f_org=open('../testing_data/'+str(seq)+'_'+str(width)+'x'+str(width)+'.rgb','rb')
            
                f_test=open('../experiment/dec/'+str(lamda)+'/'+seq+'_QP'+qp+'.rgb','rb')       
